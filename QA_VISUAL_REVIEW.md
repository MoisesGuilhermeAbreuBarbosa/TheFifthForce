...
## Authority used
The user-provided screenshots in `screenshots/reference-original/` are the authoritative visual reference. Rev02 was evaluated against the original OPEN FIELD landing page, repository, open questions, community, AI-agent, research-area and newsroom captures.
